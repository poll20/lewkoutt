...
const OtpLogin = () => {
  ...
  const handlePhoneSubmit = async (e) => {
    ...
    else setError(error || "Failed to send OTP. Please try again.");
  };
    ...
    >
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          >
            {showOTP ? (
              <FaLock style={{ color: "#4F46E5", fontSize: "22px" }} />
            ) : (
              <FaPhone style={{ color: "#4F46E5", fontSize: "22px" }} />
            )}
          </div>
          <h1
            style={{
        ...
        {!showOTP ? (
          <form onSubmit={handlePhoneSubmit} style={{ marginTop: "20px" }}>
            <input
              type="tel"
              placeholder="Enter your phone number"
              value={phoneNumber}
