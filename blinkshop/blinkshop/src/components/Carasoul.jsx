...
// import cara2 from "../components/image/cara1.jpeg"
// import cara3 from "../components/image/cara1.jpeg"
// import cara4 from "../components/image/cara1.jpeg"
// import cara5 from "../components/image/cara1.jpeg"
...
// const OVERLAY_DATA = [
//   { tag: "New collection", title: "Summer\nBloom",   cta: "Shop now" ,image:cara5},
//   { tag: "Trending now",   title: "Cool &\nCasual",  cta: "Explore",image:cara2 },
//   { tag: "Limited drops",  title: "Edit\nSeason",    cta: "View looks",image:cara3 },
//   { tag: "New collection", title: "Summer\nBloom",   cta: "Shop now",image:cara4 },
//   { tag: "Trending now",   title: "Cool &\nCasual",  cta: "Explore",image:cara1 },
...
const Carousel = ({ interval = 4000 }) => {
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(timeoutRef.current);
  }, [currentIndex, nextSlide, interval]);
  ...
  const current =
    OVERLAY_DATA[
      currentIndex % OVERLAY_DATA.length
    ];
