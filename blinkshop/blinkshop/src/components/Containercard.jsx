...
let Clickcard=(id)=>{
  ...
  return (
    <>
    <h2 className='om-newarrival' style={{textAlign:'center',marginTop:"10px"}}>NEW ARRIVAL</h2>
    ...
    <div className="om-btnnn">
        ...
        <button style={{width:"100%",margin:"auto",width:"90vw",padding:"10px 0",borderRadius:"8px", border:"1px solid rgb(190, 190, 190)"}}>
          VIEW ALL</button>
          </NavLink>
      </div>
