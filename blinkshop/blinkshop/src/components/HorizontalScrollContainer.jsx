...
const HorizontalScrollContainer = () => {
  const cards = [
    { id: 1, image: img1, description: 'Card 1 Description' },
    { id: 2, image: img2, description: 'Card 2 Description' },
    { id: 3, image: img3, description: 'Card 3 Description' },
    { id: 4, image: img4, description: 'Card 4 Description' },
    { id: 5, image: img1, description: 'Card 5 Description' },
    { id: 6, image: img1, description: 'Card 6 Description' },
  ];
